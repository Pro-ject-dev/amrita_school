            ...
            flexibleSpace: LayoutBuilder(
              builder: (context, constraints) {
                ...
                return FlexibleSpaceBar(
                  ...
                  title: Opacity(
                    opacity: scrollPercentage < 0.2
                        ? 1.0 - (scrollPercentage * 5)
                        : 0.0,
                    child: Text(
                      "Profile",
                      style: TextStyle(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CircleAvatar(
                                      ...
                                      child: Text(
                                        state.data?.empData?.employeeName?[0] ??
                                            "N/A",
                                        style: TextStyle(
                                          fontSize: 35.sp,
                                    ...
                                    Text(
                                      state.data?.empData?.employeeName ??
                                          "Not Found",
                                      style: TextStyle(
                                        fontSize: 20.sp,
                                        fontWeight: FontWeight.bold,
                                    ...
                                    SizedBox(height: 4.h),
                                    Text(
                                      state.data?.empData?.designation ??
                                          "Not Found",
                                      style: TextStyle(
                                        fontSize: 14.sp,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InfoRow(
                        ...
                        value:
                            state.data?.empData?.dateOfJoining ?? "Not Found",
                      ),
                      _Divider(),
                      InfoRow(
                      ...
                      InfoRow(
                        ...
                        value:
                            state.data?.empData?.employmentType ?? "Not Found",
                      ),
                    ],
                  ),
                ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Material(
        ...
        child: Padding(padding: EdgeInsets.all(16.sp), child: child),
      ),
    );
  }
}
